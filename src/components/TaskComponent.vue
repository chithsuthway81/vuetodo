        ...
        <v-card-actions>
          ...
          <!-- <v-dialog v-model="dialog" width="300">
            <v-card v-show="dialog">
              <v-card-text>Are u sure to delete?</v-card-text>
              <v-divider></v-divider>
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="primary" text @click="hideForm">Cancel</v-btn>
                <v-btn color="primary" text right @click="deleteTask(task)">Delete</v-btn>
              </v-card-actions>
            </v-card>
          </v-dialog>-->
